package org.dotvill.client.model;
...
public class DillagerModel<T extends Dillager> extends HumanoidModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ModUtils.resource("dillager"), "main_layer");
    private ModelPart crossedArms;

    public DillagerModel(ModelPart root) {
        super(root);
    ...
    public void performDab(T villager) {
