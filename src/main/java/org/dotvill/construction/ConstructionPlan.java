package org.dotvill.construction;
...
public class ConstructionPlan {
    ...
    public static ConstructionPlan create(ResourceLocation structurePath, ResourceManager resourceManager) {
        ...
        try (InputStream inputStream = resourceManager.open(resourceLocation)) {
            ...
            ModLogger.LOGGER.error("Structure not found {}", resourceLocation, fileNotFoundException);
            return null;
        } catch (Throwable throwable) {
            ModLogger.LOGGER.error("Could not load structure {}", resourceLocation, throwable);
            return null;
        }
    }
