...
import org.dotvill.village.map.Utils.Corner;

import javax.annotation.Nullable;

import static org.dotvill.village.map.Utils.SIDE_SIZE_MAX_GARDEN;
...
public class Bud {
    ...
    private Bud(VillageMap map, BudType type, BlockPos realPos, Corner corner, Direction[] adjacentPaths){
        this.type = type;
    ...
    /**
     * Create a new instance of a Bud and adds it to the VillageMap. If a similar Bud exists, returns null.
     * @param map VillageMap of the bud.
     ...
     */
    @Nullable
    public static Bud createBud(VillageMap map, BudType type, BlockPos realPos, Corner corner, Direction[] adjacentPaths){
        ...
        return new Bud(map, type, realPos.atY(80)/*VillageMapDisplay.getSurfaceY(realPos))*/, corner, adjacentPaths);
    }

    /**
     * Create a new instance of a Bud of DEFAULT type, and adds it to the VillageMap. If a similar Bud exists, returns null.
     * @param map VillageMap of the bud.
     * @param realPos BlockPos of the bud.
     * @param corner Corner type of this bud.
     * @param adjacentPaths Direction where there is a MapPath from the realPos.
     ...
     */
    @Nullable
    public static Bud createBud(VillageMap map, BlockPos realPos, Corner corner, Direction[] adjacentPaths){
        return createBud(map, BudType.DEFAULT, realPos, corner, adjacentPaths);
    }

    /**
     * @return The squared distance to the village center.
     */
    ...
    /**
     * Function that updates the squared distance between this bud and the village center.
     * @param map VillageMap of the bud.
     */
    public void setSquaredDistToCenter(VillageMap map){
        this.squaredDistToCenter = this.getSquaredDistTo(map.getVillageCenter());
    }
     ...
     * @param map The VillageMap of this Bud.
     ...
     */
    public MapGarden createAdaptedGarden(VillageMap map, boolean clockwise) {
        int[] sizes = new int[4];
