...
public abstract class MapBuild {
    ...
    /**
     * @return The id of the Build. 0 if the Build is not yet on the VillageMap.
     */
    public int getId(){
        return this.id;
    }
    ...
    /**
     * @return The Direction of the MapBuild. Null if the MapBuild is not on the VillageMap yet.
     */
    @Nullable
    ...
    /**
     * Function called to add this MapBuild to the given VillageMap, knowing that it can be added with the given parameters.
     * @param map VillageMap in which this MapBuild will be added.
     * @param bud Bud used to put set this Building on the VillageMap.
     * @param dir Direction corresponding to the orientation of this MapBuild.
     */
    public void addToMap(VillageMap map, Bud bud, Direction dir){
    ...
    /**
     * Function called just after this MapBuild was added to the VillageMap.
     * Override it to add post placement steps, like Buds generation.
     * @param map VillageMap in which we add the Build.
     */
    protected abstract void onAddedToMap(VillageMap map);
     ...
     * @param map VillageMap where we are trying to build the MapBuild.
     ...
     */
    public boolean canBeBuiltOnBud(VillageMap map, Bud bud, Direction dir){
