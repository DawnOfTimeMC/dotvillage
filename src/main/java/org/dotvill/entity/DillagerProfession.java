...
public enum DillagerProfession {
    /** Food producers **/
    ...
    DillagerProfession(ProfessionCategory category){this.professionCategory = category;}
    ...
    public static DillagerProfession byId(byte id) {
        for(DillagerProfession profession : DillagerProfession.values()) {
