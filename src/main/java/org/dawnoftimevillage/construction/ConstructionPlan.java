package org.dawnoftimevillage.construction;
...
public class ConstructionPlan {
    ...
    public static ConstructionPlan create(ResourceLocation structurePath, ResourceManager resourceManager) {
        ...
        try (InputStream inputStream = resourceManager.open(resourceLocation)) {
            ...
            DotvLogger.LOGGER.error("Structure not found {}", resourceLocation, fileNotFoundException);
            return null;
        } catch (Throwable throwable) {
            DotvLogger.LOGGER.error("Could not load structure {}", resourceLocation, throwable);
            return null;
        }
    }
